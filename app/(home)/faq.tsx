      ...
      >
        ...
        <View style={styles.contactSection}>
          ...
          <TouchableOpacity style={styles.contactButton} activeOpacity={0.8}>
            ...
            <Text style={styles.contactButtonText}>support@freshly.app</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </View>
...
}> = ({ category, categoryIndex, isExpanded, expandedItem, onToggleCategory, onToggleItem }) => {
  return (
    <View style={styles.categoryContainer}>
      ...
      >
        ...
        <View style={styles.categoryTitleContainer}>
          ...
          <Text style={styles.categoryCount}>{category.items.length} questions</Text>
        </View>
        <Ionicons
              ...
              >
                <View style={styles.questionRow}>
                  <View style={styles.questionNumber}>
                    <Text style={styles.questionNumberText}>{itemIndex + 1}</Text>
                  </View>
                ...
                {isItemExpanded && (
                  <View style={styles.answerContainer}>
                    <View style={[styles.answerLine, { backgroundColor: category.color }]} />
